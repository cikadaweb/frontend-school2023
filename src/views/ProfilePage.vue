    ...
    <div class="container profile-page__container">
      <div class="profile-page__row">
        <div class="profile-page__column profile-page__column_image">
          ...
          <AppProfilePicture :img="currentUser.picture"/>

        </div>
        <div class="profile-page__column profile-page__column_text">
          <div class="profile-page__user-info">
            <span class="profile-page__text profile-page__text_name">{{ currentUser.name }}</span>

            <AppUserBadge :state="currentUser.status"/>
...
<script>
import AppProfilePicture from '@/components/profile-page/AppProfilePicture.vue'
